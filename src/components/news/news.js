      ...
      <ul class="news_list">\
        <li class="news_item news_item__white">\
          ...
          <p class="news_item__description">\
            ...
            architecto sunt laboriosam porro fugit neque nisi! Sit voluptates a\
            adipisci, tempora aperiam sapiente impedit ad quia, voluptas\
            provident tempore itaque!\
          </p>\
          <svg\
            class="news_item__arrow"\
            width="23"\
            height="38"\
            viewBox="0 0 23 38"\
            fill="none"\
        ...
        <li class="news_item news_item__black">\
          ...
          <p class="news_item__description" style="color: white">\
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quis,\
            architecto sunt laboriosam porro fugit neque nisi! Sit voluptates a\
            adipisci, tempora aperiam sapiente impedit ad quia, voluptas\
            provident tempore itaque!\
